...
public class MessageTest extends UnitTest {
	...
	@Before
	public void setup() {
		mary = new User("mary", "colllins", "mary@collins.com", "secret", 20,
				"irish");
		mary.save();

		joan = new User("joan", "colllins", "joan@collins.com", "secret", 20,
				"irish");
		joan.save();
	}
	...
	public void testUpdateMessage() {
		Message msg1 = new Message(mary, joan, "Hi there - how are you");
		msg1.save();
		msg1.messageText = "Hello there!";
		assertEquals(msg1.messageText, "Hello there!");
		msg1.delete();
	}
